...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/throbbing-moon-2bbb
```

A live public deployment of this template is available at [https://throbbing-moon-2bbb.templates.workers.dev](https://throbbing-moon-2bbb.templates.workers.dev)
